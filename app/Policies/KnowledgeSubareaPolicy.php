...
class KnowledgeSubareaPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if($user->hasPermissionTo('index_knowledge_subareas')){
            return true;
        }
        return false;
    }
    ...
    public function create(User $user)
    {
        ...
        if($user->hasPermissionTo('create_knowledge_subareas')){
            return true;
        }
        return false;
    }
    ...
    public function update(User $user, KnowledgeSubarea $knowledgeSubarea)
    {
        ...
        if($user->hasPermissionTo('edit_knowledge_subareas')){
            return true;
        }
        return false;
    }
    ...
    public function delete(User $user, KnowledgeSubarea $knowledgeSubarea)
    {
        ...
        if($user->hasPermissionTo('destroy_knowledge_subareas')){
            return true;
        }
        return false;
    }
