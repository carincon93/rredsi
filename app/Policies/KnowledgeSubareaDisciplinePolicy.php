...
class KnowledgeSubareaDisciplinePolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if($user->hasPermissionTo('index_knowledge_subarea_disciplines')){
            return true;
        }
        return false;
    }
    ...
    public function create(User $user)
    {
        ...
        if($user->hasPermissionTo('create_knowledge_subarea_disciplines')){
            return true;
        }
        return false;
    }
    ...
    public function update(User $user, KnowledgeSubareaDiscipline $knowledgeSubareaDiscipline)
    {
        ...
        if($user->hasPermissionTo('edit_knowledge_subarea_disciplines')){
            return true;
        }
        return false;
    }
    ...
    public function delete(User $user, KnowledgeSubareaDiscipline $knowledgeSubareaDiscipline)
    {
        ...
        if($user->hasPermissionTo('destroy_knowledge_subarea_disciplines')){
            return true;
        }
        return false;
    }
