...
class EducationalToolPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if($user->hasPermissionTo('index_educational_tools')){
            return true;
        }
        return false;
    }
    ...
    public function create(User $user)
    {
        ...
        if($user->hasPermissionTo('create_educational_tools')){
            return true;
        }
        return false;
    }
    ...
    public function update(User $user, EducationalTool $educationalTool)
    {
        ...
        if($user->hasPermissionTo('edit_educational_tools')){
            return true;
        }
        return false;
    }
    ...
    public function delete(User $user, EducationalTool $educationalTool)
    {
        ...
        if($user->hasPermissionTo('destroy_educational_tools')){
            return true;
        }
        return false;
    }
