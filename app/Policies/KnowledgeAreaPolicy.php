...
class KnowledgeAreaPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if($user->hasPermissionTo('index_knowledge_areas')){
            return true;
        }
        return false;
    }
    ...
    public function create(User $user)
    {
        ...
        if($user->hasPermissionTo('create_knowledge_areas')){
            return true;
        }
        return false;
    }
    ...
    public function update(User $user, KnowledgeArea $knowledgeArea)
    {
        ...
        if($user->hasPermissionTo('edit_knowledge_areas')){
            return true;
        }
        return false;
    }
    ...
    public function delete(User $user, KnowledgeArea $knowledgeArea)
    {
        ...
        if($user->hasPermissionTo('destroy_knowledge_areas')){
            return true;
        }
        return false;
    }
