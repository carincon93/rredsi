...
class UpdateNodeAdminRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'email'             => 'required|string|max:191|email|unique:users,email,'.$this->route('node_admin')->id.',id',
            'document_type'     => 'required|string| max:2',
            'document_number'   => 'required|numeric|min:0|max:9999999999|unique:users,document_number,'.$this->route('node_admin')->id.',id',
