<x-app-layout>
    <x-slot name="header">
        ...
        <div>
            <a href="{{route('nodes.update', [$researchGroup])}}">
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <h3 class="text-lg font-medium text-gray-900">Informacion de grupos de busqueda <span class="text-capitalize">{{ $node->state }}</h3>
                </div>
