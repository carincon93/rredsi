                                ...
                                <td class="py-2 text-left">
                                    <div class="lg:flex items-center lg:justify-around">
                                        ...
                                        <div class="lg:hidden">
                                            ...
                                            @can('show_node')
                                                <x-jet-dropdown-link class="inline-block" href="{{ route('nodes.show', $node) }}">
                                            ...
                                            @endcan
                                            @can('edit_node')
                                                <x-jet-dropdown-link class="inline-block" href="{{ route('nodes.edit', $node) }}">
                                                    <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            @endcan
                                            @can('destroy_node')
                                                <x-jet-dropdown-link class="modal-open inline-block" onclick="modal('{{ route('nodes.destroy', $node) }}')">
                                                    <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
