    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 dark:bg-gray-800 overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-4">
                <div class="flex justify-center mb-5 md:mb-0 text-center">
                ...
                <div class="flex justify-center mt-5 mb-7 md:mt-0 md:mb-0">
                    <ul class="list-unstyled block text-center">
                        <li>
                            <h4 class="mb-4 text-gray-600 pr-3">ACERCA DE</h4>
                        </li>
                        <li>
                ...
                <div class="flex justify-center  mt-5 md:mt-0 mb-9 md:mb-0">
