      ...
      {{-- logosidebar --}}
        ...
        <nav :class="{'block': open, 'hidden': !open}" class="scroll flex-grow md:block pb-4 md:pb-0 md:overflow-y-auto">
            ...
            @if( Auth::user()->hasRole(5) )
                ...
                <a @click="open = !open" class=" cursor-pointer mt-4 mb-4 mr-2 w-full flex items-center py-2 text-sm text-blue-900 hover:bg-gray-200 px-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 px-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="mr-1/12 ml-1 text-black" style="width: 18px;" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span>
                            <svg class="h-4 w-4" viewBox="-10 0 30 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('experiences.index') }}" class="mt-4 mb-4 mr-2 w-full flex items-center py-2 text-sm text-blue-900 hover:bg-gray-200 px-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 px-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17.216" height="15.209" viewBox="0 0 17.216 15.209" class="mr-1/12 ml-1 text-black" style="width: 18px;">
                    </svg>
                    <span class="text-gray-700">{{ __('Mis Experiencias') }}</span>
                </a>

                <a href="{{ route('showexperiences.index') }}" class="mt-4 mb-4 mr-2 w-full flex items-center py-2 text-sm text-blue-900 hover:bg-gray-200 px-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 px-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17.216" height="15.209" viewBox="0 0 17.216 15.209" class="mr-1/12 ml-1 text-black" style="width: 18px;">
                    </svg>
                    <span class="text-gray-700">{{ __('Ver experiencias') }}</span>
                </a>
