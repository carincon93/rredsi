   ...
   <div class="grid grid-cols-2">
      ...
      <div class="flex-auto w-full mb-1 text-xs space-y-2">
         ...
         <div class="h-8 mt-1 flex rounded-md shadow-sm">
            <input  class=" appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg  py-4 px-4" placeholder="Nombre del producto" name="Nombre" value="{{ isset($product->Nombre)?$product->Nombre:old('Nombre') }}" id="Nombre" min="5" max="190" required>
         </div>
      </div>
   </div>
