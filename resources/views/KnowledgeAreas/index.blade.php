        ...
        <div >
            ...
            <div class="col-start-1 col-end-7 md:col-end-8 md:col-span-3 xl:col-end-10 xl:col-span-2 m-auto">
                ...
                <a href="{{ route('knowledge-areas.create') }}">
                    <div class="text-center text-base text-blue-900 group-hover:text-blue-500 font-medium leading-none bg-white rounded-lg shadow-sm group-hover:shadow-lg py-3 px-3 md:px-5 border border-transparent transform group-hover:-translate-y-0.5 transition-all duration-150">
                                ...
                                <div class="lg:flex items-center lg:justify-around">
                                    ...
                                    <div class="lg:hidden">
                                        ...
                                        @can('show_knowledge_area')
                                            <x-jet-dropdown-link class="inline-block" href="{{ route('knowledge-areas.show', [$knowledgeArea]) }}">
                                        ...
                                        @can('edit_knowledge_area')
                                            <x-jet-dropdown-link class="inline-block" href="{{ route('knowledge-areas.edit', [$knowledgeArea]) }}">
                                                <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        @can('destroy_knowledge_area')
                                            <x-jet-dropdown-link class="modal-open inline-block" onclick="modal('{{ route('knowledge-areas.destroy', [$knowledgeArea]) }}')">
                                                <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
