...
<x-app-layout>
    <x-slot name="header">
        <div class="grid grid-cols-6 gap-4  xl:grid-cols-9 xl:gap-3">
            ...
            <div class="col-start-1 col-end-7 md:col-end-8 md:col-span-3 xl:col-end-12 xl:col-span-2 m-auto">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-4">
            <div class="md:col-span-1">
                <x-jet-section-title>
                    ...
                    <x-slot name="description">Añadir una sub-área de conocimiento</x-slot>
                </x-jet-section-title>
            </div>
