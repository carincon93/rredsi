                ...
                <div class="ml-20 bg-white bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                    ...
                    @foreach ($projects as $project)
                        <div class="max-w-xs bg-white shadow-lg rounded-lg overflow-hidden my-10">
                            <div class="px-4 py-2">
                                <h1 class="text-gray-900 font-bold text-3xl uppercase"><?php echo($project->title)?></h1>
                                <p class="text-gray-600 text-sm mt-1">{{ substr($project->abstract, 0 ,310) }}@if(count_chars($project->abstract) > 310)...@endif</p>
                            </div>
                            ...
                            <div class="flex items-center justify-between px-4 py-2 bg-gray-900">
                                <h1 class="text-gray-300 font-bold text-xl">{{ optional($researchTeam->researchGroup)->educationalInstitutionFaculty->educationalInstitution->name }}</h1>
