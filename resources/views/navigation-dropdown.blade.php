<nav x-data="{ open: false }" class="bg-gradient-to-l shadow to-color-1">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="animate-pulse flex-shrink-0 flex items-center">
                    <a href="{{ route('nodes.dashboard', [request()->route('node')->id]) }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if (request()->route('node') && request()->route('educational_institution'))
                        ...
                        <x-jet-nav-link href="{{ route('/', request()->route('node')->id) }}" :active="request()->routeIs('/')" class="text-gray-600 hover:text-gray-400">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('nodes.dashboard', [request()->route('node')->id]) }}" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
