<title>{{ "Herramientas educativas - ".config('app.name') }}</title>
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="bg-white shadow-xl sm-rounded-lg">
                <x-data-table>
                    ...
                    <x-slot name="tbodyData">
                        @foreach ($educationalTools as $educationalTool)
                                    ...
                                    <div class="lg:flex items-center lg:justify-around">
                                            ...
                                            <div class="lg:hidden">
                                                <span class="lg:hidden top-0 left-0 ml-2  px-2 text-gray-400 py-1 text-xs font-bold uppercase block">{{ __('Actions') }}</span>
                                                    @can('show_educational_tool')
                                                        <x-jet-dropdown-link class="inline-block" href="{{ route('nodes.educational-institutions.faculties.educational-environments.educational-tools.show', [$node, $educationalInstitution, $faculty, $educationalEnvironment, $educationalTool]) }}">
                                                    ...
                                                    @can('edit_educational_tool')
                                                        <x-jet-dropdown-link class="inline-block" href="{{ route('nodes.educational-institutions.faculties.educational-environments.educational-tools.edit', [$node, $educationalInstitution, $faculty, $educationalEnvironment, $educationalTool]) }}">
                                                            <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                            </svg>
                                                        </x-jet-dropdown-link>
                                                    @endcan
                                                    @can('destroy_educational_tool')
                                                        <x-jet-dropdown-link class="modal-open inline-block" onclick="modal('{{ route('nodes.educational-institutions.faculties.educational-environments.educational-tools.destroy', [$node, $educationalInstitution, $faculty, $educationalEnvironment, $educationalTool]) }}')">
                                                            <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div class="hidden lg:table-cell">
                                            <x-jet-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                    @can('show_educational_tool')
                                                    <x-jet-dropdown-link href="{{ route('nodes.educational-institutions.faculties.educational-environments.educational-tools.show', [$node, $educationalInstitution, $faculty, $educationalEnvironment, $educationalTool]) }}">
                                                        {{ __('Show') }}
                                                    </x-jet-dropdown-link>
                                                    @endcan
                                                    @can('edit_educational_tool')
                                                    <x-jet-dropdown-link href="{{ route('nodes.educational-institutions.faculties.educational-environments.educational-tools.edit', [$node, $educationalInstitution, $faculty, $educationalEnvironment, $educationalTool]) }}">
                                                        {{ __('Edit') }}
                                                    </x-jet-dropdown-link>
                                                    @endcan
                                                    @can('destroy_educational_tool')
                                                    <x-jet-dropdown-link class="modal-open hover:cursor-pointer" onclick="modal('{{ route('nodes.educational-institutions.faculties.educational-environments.educational-tools.destroy', [$node, $educationalInstitution, $faculty, $educationalEnvironment, $educationalTool]) }}')">
                                                        {{ __('Delete') }}
                                                    </x-jet-dropdown-link>
                                                    @endcan
                                                </x-slot>
