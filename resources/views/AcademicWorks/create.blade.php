    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="md:grid md:grid-cols-3 md:gap-4">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('academic-works.store') }}" novalidate>
                    @csrf
                    ...
                    <div class="mt-2">
                        ...
                        <x-jet-input id="authors" class="block mt-1 w-full" type="text" min="" max="" name="authors" value="{{ old('authors') }}" required />
                        <x-jet-input-error for="authors" class="mt-2" />
                    </div>

                    <div class="mt-2">
                        <x-jet-label for="grade" value="{{ __('Grade') }}" />
                        <x-jet-input id="grade" class="block mt-1 w-full" type="text" min="" max="" name="grade" value="{{ old('grade') }}" required />
                        <x-jet-input-error for="grade" class="mt-2" />
                    </div>

                    <div class="mt-2">
                        <x-jet-label for="mentors" value="{{ __('Mentors') }}" />
                        <x-jet-input id="mentors" class="block mt-1 w-full" type="text" min="" max="" name="mentors" value="{{ old('mentors') }}" required />
                    ...
                    <div class="mt-2">
                        ...
                        <select id="graduation_id" name="graduation_id" class="block mt-1 p-4 w-full" value="{{ old('graduation_id') }}" required >
