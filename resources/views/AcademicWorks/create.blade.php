<title>{{ "Crear un trabajo académico - ".config('app.name') }}</title>
<x-app-layout>
    <x-slot name="header">
        <div class="col-start-2 col-span-4 md:col-start-1 md:col-span-3 xl:col-start-1 xl:col-span-3">
            <h2 class="font-display text-white text-3xl leading-9 font-semibold sm:text-3xl sm:leading-9">
                ...
                <span class="sm:block text-lg text-purple-300">
                    <a  class="text-white font-weight underline" href="{{ route('user.profile.user-graduations.user-academic-works.index', [$userGraduation]) }}">Lista de trabajos académicos</a> / Crear trabajo académico
                </span>
            </h2>
        </div>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="md:grid md:grid-cols-3 md:gap-4">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('user.profile.user-graduations.user-academic-works.store', [$userGraduation]) }}">
                    @csrf
                    ...
                    <div class="mt-1/6">
                        ...
                        <select id="type" name="type" class="form-select w-full" required >
                            ...
                            <option {{ old('type') == "tesis de maestría" ? "selected" : "" }} value="tesis de maestría">Tesis de maestría</option>
                            <option {{ old('type') == "trabajo de grado" ? "selected" : "" }} value="trabajo de grado">Trabajo de grado</option>
                            <option {{ old('type') == "trabajos de i+d+I con formación" ? "selected" : "" }} value="trabajos de i+d+I con formación">Trabajos de i+d+I con formación</option>
                            <option {{ old('type') == "apoyo de programas de formación" ? "selected" : "" }} value="apoyo de programas de formación">Apoyo de programas de formación</option>
                        </select>
