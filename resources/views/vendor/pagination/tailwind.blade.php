@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between grid grid-cols-1 md:grid-cols-3 block">
            <div>               
                Viendo
                <div class="inline-block font-medium">{{ $paginator->firstItem() }}</div>
                a
                <div class="inline-block font-medium">{{ $paginator->lastItem() }}</div>
                de
                <div class="inline-block font-medium">{{ $paginator->total() }}</div>
                Resultados
            </div>
