<title>{{ "Resultado de búsqueda de estudiantes - ".config('app.name') }}</title>
                        ...
                        <div class="ml-8 w-full">
                            <div>
                                <p class="pre-line-initial text-2xl mb-4">
                                    <a href="{{ route('nodes.explorer.searchRoles.showUser', [$node, $roleMember]) }}">{{ $roleMember->name }} <small class="bg-blue-100 p-2 text-xs rounded-3xl ml-4 hover:bg-blue-200">Más información</small></a>
                                </p>
