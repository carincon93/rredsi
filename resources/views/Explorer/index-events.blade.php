        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">           
            ...
            <div class="p-6 mt-4">
                ...
                @forelse ($node->events as $event)
                    ...
                    <div>
                        <div class="p-4">
                            <p class="text-2xl mb-8">{{ $event->name }}</p>
                            ...
                            <p class="mb-2 inline-flex">
                                {{ __('Description') }}:
                            </p>
                            <p class="text-justify text-gray-400 mb-4 ml-8">
                                <small>
                                    {{ $event->description }}
                                </small>
                            </p>
                            ...
                            <p class="mt-2 inline-flex">{{ __('Knowledge subarea disciplines') }}</p>
                            <p class="text-gray-400 ml-8">
                                @foreach ($event->knowledgeSubareaDisciplines as $knowledgeSubareaDiscipline)
                            ...
                            <p class="mt-2 inline-flex">{{ __('Info link') }}</p>
                            <p class="text-gray-400 ml-8">
