    ...
    <x-slot name="header">
        <h2 class="font-display text-white text-3xl leading-9 font-semibold sm:text-3xl sm:leading-9">
            ...
            <span class="sm:block text-lg text-purple-300">
                <a class="text-white font-weight underline" href="{{ route('nodes.educational-institutions.events.index', [$node, $educationalInstitution]) }}">Lista de eventos de institución educativa</a> / Editar evento de institución educativa
            </span>
        </h2>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-4">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('nodes.educational-institutions.events.update', [$node, $educationalInstitution, $event]) }}">
                    ...
                    <x-checkbox-knowledge-subarea-discipline :knowledgeAreas="$knowledgeAreas" :model="$event" />
