            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('nodes.educational-institutions.events.update', [$node, $educationalInstitution, $event]) }}">
                    ...
                    <div>
                        ...
                        <x-jet-input id="name" class="block mt-1 w-full" type="text" maxlength="191" name="name" value="{{ old('name') ?? $event->name }}" required />
                        <x-jet-input-error for="name" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-jet-label for="location" value="{{ __('Location') }}" />
                        <x-jet-input id="location" class="block mt-1 w-full" type="text" maxlength="191" name="location" value="{{ old('location') ?? $event->location }}" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="link" class="block mt-1 w-full" type="url" maxlength="191" name="link" value="{{ old('link') ?? $event->link }}" required />
