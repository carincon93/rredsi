<title>{{ "Eventos institucionales - ".config('app.name') }}</title>
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-display text-white text-3xl leading-9 font-semibold sm:text-3xl sm:leading-9">
            {{ __('Educational institution events') }}
            <span class="sm:block text-purple-300">
                Lista de eventos de institución educativa
            </span>
        </h2>
        @can('create_educational_institution_event')
                                ...
                                <td class="py-2 text-left">
                                    <div class="hidden sm:flex sm:items-center justify-around">
                                        <x-jet-dropdown align="right" width="48">
                                            ...
                                            <x-slot name="content">
                                                @can('show_educational_institution_event')
                                                ...
                                                @endcan
                                                @can('destroy_educational_institution_event')
