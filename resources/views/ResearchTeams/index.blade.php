        ...
        <div class="col-start-2 col-span-4 md:col-start-1 md:col-span-3 xl:col-start-1 xl:col-span-3">
            <h2 class="font-display text-white text-center md:text-left text-2xl leading-9 font-semibold sm:text-3xl sm:leading-9">
                ...
                <span class="text-base sm:text-lg block text-purple-300">
                    Lista de semilleros de investigación
                </span>
            </h2>
        </div>
                        ...
                        @foreach ($researchTeams as $researchTeam)
                            <tr class="bg-white flex flex-col flex-no wrap lg:table-row mb-2 lg:mb-0">
                                <td>
                                    ...
                                    <p>{{ $researchTeam->name }}</p>
                                </td>
                                <td>
                                    <span class="ml-2 lg:hidden top-0 left-0 px-2 text-gray-400 py-1 text-xs font-bold uppercase block">{{ __('Research group') }}</span>
                                    <p class="">{{ optional($researchTeam->researchGroup)->name }}</p>
                                </td>
                                <td>
                                    <span class="ml-2 lg:hidden top-0 left-0 px-2 text-gray-400 py-1 text-xs font-bold uppercase block">{{ __('Mentor email') }}</span>
                                    <p class="">{{ $researchTeam->mentor_email }}</p>
                                </td>
                                ...
                                <td class="py-2 text-left">
                                    <div class="lg:flex items-center lg:justify-around">
                                        ...
                                        <div class="lg:hidden">
                                            ...
                                            <x-jet-dropdown-link class="inline-block" href="{{ route('nodes.educational-institutions.faculties.research-groups.research-teams.projects.index', [$node, $educationalInstitution, $faculty, $researchGroup, $researchTeam]) }}">
                                                <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polygon points="12 2 2 7 12 12 22 7 12 2" /><polyline points="2 17 12 22 22 17" /> <polyline points="2 12 12 17 22 12" />
                                                </svg>
                                            </x-jet-dropdown-link>
