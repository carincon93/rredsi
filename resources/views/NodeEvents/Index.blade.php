                                    ...
                                    <div class="lg:flex items-center lg:justify-around">
                                        {{-- ICONOS SOLO VISIBLE EN MOVIL DE PANTALLA -> XS.. A.. MD  --}}
                                         ...
                                         <div class="lg:hidden">
                                            <span class="lg:hidden top-0 left-0 ml-2  px-2 text-gray-400 py-1 text-xs font-bold uppercase block">{{ __('Actions') }}</span>
                                                @can('show_node_event')
                                                    <x-jet-dropdown-link class="inline-block" href="{{ route('nodes.events.show', [$node, $event])}}">
                                        ...
                                        <div class="hidden lg:table-cell">
                                            <x-jet-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                    @can('show_node_event')
                                                    <x-jet-dropdown-link href="{{ route('nodes.events.show', [$node, $event])}}">
                                                        {{ __('Show') }}
                                                    </x-jet-dropdown-link>
                                                    @endcan
                                                    @can('edit_node_event')
