    ...
    <x-slot name="header">
        <h2 class="font-display text-white text-3xl leading-9 font-semibold sm:text-3xl sm:leading-9">
            ...
            <span class="sm:block text-purple-300">
                Update educational institution user info
            </span>
        </h2>
        <div>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="md:grid md:grid-cols-3 md:gap-4">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('nodes.educational-institutions.users.update', [$node, $educationalInstitution, $user]) }}" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="interests" name="interests" class="block mt-1 p-4 w-full" value="{{ old('interests') }}" required >{{ old('interests') ?? $user->interests }}</textarea>
