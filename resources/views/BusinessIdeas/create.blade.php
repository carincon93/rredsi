        ...
        <div class="md:grid md:grid-cols-3 md:gap-4">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="#">
                    @csrf
                    <div>
                        <x-jet-label class="mb-4" for="business_id" value="{{ __('Empresa') }}" />
                        <x-jet-input id="business_id" class="block mt-1 w-full" type="text" max="191" name="name" value="{{ old('business_id') }}" required />
