<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-display text-center md:text-left text-white text-3xl leading-9 font-semibold sm:text-3xl sm:leading-9">
        ...
        <div class="mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div class="transition duration-500 ease-in-out transform hover:-translate-y-1 h-64 bg-white hover:bg-gray-200 overflow-hidden shadow-xl sm-rounded-lg p-4" >
                    <a href="{{ route('nodes.educational-institutions.faculties.index', [$node, $educationalInstitution]) }}" class="flex flex-col h-56 items-center justify-center">
                        ...
                        <h1 class="text-center text-2xl md:text-sm xl:text-2xl text-gray-400 mx-auto">{{ __('Educational institution faculties') }}</h1>
                    </a>
                </div>
            ...
            <div class="grid md:grid-cols-3 mt-3 gap-4">
                ...
                <div class="transition duration-500 ease-in-out transform hover:-translate-y-1 h-64 bg-white hover:bg-gray-200 overflow-hidden shadow-xl lg-rounded-lg p-4 flex">
