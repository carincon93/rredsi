        ...
        <div class="container mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div class="transition duration-500 ease-in-out transform hover:-translate-y-1 h-64 bg-white  hover:bg-gray-200 overflow-hidden shadow-xl lg-rounded-lg p-4 flex" >
                    <a href="{{ route('nodes.educational-institutions.faculties.index', [$node, $educationalInstitution]) }}" class="flex flex-col h-56 items-center justify-around w-96">
                        ...
                        <h1 class="text-2xl text-center text-gray-400">{{ __('Educational institution faculties') }}</h1>
                    </a>
                </div>
