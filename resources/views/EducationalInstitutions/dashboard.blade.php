            ...
            <div class="grid md:grid-cols-3 gap-4">
                ...
                <div class="h-64 bg-white overflow-hidden shadow-xl sm-rounded-lg p-4 flex">
                    <a href="#" class="flex flex-col h-56 items-center justify-around w-96">
                        ...
                        <h1 class="text-2xl capitalize text-gray-400">{{ __('academic programs') }}</h1>
                    </a>
                </div>
                <div class="h-64 bg-white overflow-hidden shadow-xl sm-rounded-lg p-4 flex">
                    <a href="#" class="flex flex-col h-56 items-center justify-around w-96">
            ...
            <div class="grid md:grid-cols-3 gap-4 mt-4">
                <div class="h-64 bg-white overflow-hidden shadow-xl sm-rounded-lg p-4">
                    <a href="#" class="flex flex-col h-56 items-center justify-around w-96">
                        ...
                        <h1 class="text-2xl capitalize text-gray-400">{{ __('research groups') }}</h1>
                    </a>
                </div>
                <div class="h-64 bg-white overflow-hidden shadow-xl sm-rounded-lg p-4 flex">
                    <a href="#" class="flex flex-col h-56 items-center justify-around w-96">
                        ...
                        <h1 class="text-2xl capitalize text-gray-400">{{ __('research teams') }}</h1>
                    </a>
                </div>
                <div class="h-64 bg-white overflow-hidden shadow-xl sm-rounded-lg p-4 flex">
                    <a href="#" class="flex flex-col h-56 items-center justify-around w-96">
                        ...
                        <h1 class="text-2xl capitalize text-gray-400">{{ __('educational environments') }}</h1>
                    </a>
                </div>
            </div>
        </div>
