<title>{{ "Crear institución educativa - ".config('app.name') }}</title>
<x-app-layout>
    <x-slot name="header">
        <div class="col-start-2 col-span-4 md:col-start-1 md:col-span-3 xl:col-start-1 xl:col-span-3">
            <h2 class="font-display text-white text-center md:text-left text-2xl leading-9 font-semibold sm:text-3xl sm:leading-9">
                ...
                <span class="text-base sm:text-lg block text-purple-300">
                    <a class="text-white font-weight underline" href="{{ route('nodes.educational-institutions.index', [$node]) }}">Lista de las instituciones educativas</a> / Crear institución educativa
                </span>
            </h2>
        </div>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-4">
            <div class="md:col-span-1">
                <x-jet-section-title>
                    ...
                    <x-slot name="description">Crear una institución educativa</x-slot>
                </x-jet-section-title>
            </div>
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('nodes.educational-institutions.store', [$node]) }}">
                    @csrf
                    ...
                    <div class="mt-1/6">
                        <x-jet-label class="mb-4" for="city" value="{{ __('City') }}" />
                    ...
                    <div class="mt-1/6">
                        ...
                        <x-jet-input id="phone_number" class="block mt-1 w-full" type="number" min="" maxlength="7" name="phone_number" value="{{ old('phone_number') }}" required />
                    ...
                    <div class="mt-1/6">
                        <x-jet-label class="mb-4" for="administrator_id" value="{{ __('Educational institution admin') }}" />
