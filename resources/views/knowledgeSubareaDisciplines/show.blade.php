                          ...
                          <div class="tab-content tab-space">
                                ...
                                {{-- tab info knowledge subarea diciplines --}}
                                    <div>
                                        ...
                                        <div class="md:grid md:grid-cols-3 md:gap-6">
                                            ...
                                            <h3 class="text-lg font-medium text-gray-900">Información del knowledge subarea dicipline</h3>
                                            </div>
                            ...
                            <div class="hidden" id="tab-options">
                                ...
                                <div>
                                    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                                            <div class="md:col-span-1">
                                                <h3 class="text-lg font-medium text-gray-900">Información de <br> research team</h3>
                                            </div>
