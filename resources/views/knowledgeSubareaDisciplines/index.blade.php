                                      ...
                                      {{-- ICONOS SOLO VISIBLE EN MOVIL DE PANTALLA -> XS.. A.. MD  --}}
                                        ...
                                        <div class="lg:hidden">
                                            ...
                                            @can('show_knowledge_subarea_discipline')
                                                <x-jet-dropdown-link class="inline-block" href="{{ route('knowledge-subarea-disciplines.show', [$knowledgeSubareaDiscipline]) }}">
                                            ...
                                            @can('edit_knowledge_subarea_discipline')
                                                <x-jet-dropdown-link class="inline-block" href="{{ route('knowledge-subarea-disciplines.edit', [$knowledgeSubareaDiscipline]) }}">
                                                    <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            @can('destroy_knowledge_subarea_discipline')
                                                <x-jet-dropdown-link class="modal-open inline-block" onclick="modal('{{ route('knowledge-subarea-disciplines.destroy', [$knowledgeSubareaDiscipline]) }}')">
                                                    <svg class="inline p-0 m-0 h-5 w-6 mb-2 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
