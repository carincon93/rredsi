        ...
        <div class="col-start-2 col-span-4 md:col-start-1 md:col-span-3 xl:col-start-1 xl:col-span-3">
            <h2 class="font-display text-white text-center md:text-left text-2xl leading-9 font-semibold sm:text-3xl sm:leading-9">
                ...
                <span class="text-base sm:text-lg block text-purple-300">
                    <a class="text-white font-weight underline" href="{{ route('knowledge-subarea-disciplines.index') }}">Lista de disciplinas de subárea de concimiento</a> / Editar disciplina de subárea de conocimiento
                </span>
            </h2>
        </div>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-4">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('knowledge-subarea-disciplines.update', $knowledgeSubareaDiscipline->id)}}">
                    ...
                    <div class="mt-1/6">
                        <x-jet-label class="mb-4" for="knowledge_subarea_id" value="{{ __('Knowledge area') }}" />
