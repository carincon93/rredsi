<x-app-layout>
    ...
    <div class="p-12">
        <div class="container mx-auto">
            <h1 class="text-gray-400 mb-4">Administre los módulos relacionados con la facultad de <span class="text-uppercase">{{ $faculty->name }}</span> de la institución educativa <span class="text-uppercase">{{ $educationalInstitution->name }}</span> del nodo <span clas="text-capitalize">{{ $node->state }}</span>.</h1>
            <div class="grid md:grid-cols-3 gap-4">
                ...
                <div class="transition duration-500 ease-in-out transform hover:-translate-y-1 h-64 bg-white hover:bg-gray-200 overflow-hidden shadow-xl sm-rounded-lg p-4">
                    <a href="{{ route('nodes.educational-institutions.faculties.research-groups.index', [$node, $educationalInstitution, $faculty]) }}" class="flex flex-col h-56 items-center justify-around w-96">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-14 h-14 text-gray-400 mr-20">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                        <h1 class="text-2xl text-gray-400 mr-15">{{ __('Research groups') }}</h1>
                        <p class="text-center text-gray-500 mr-20">Administre grupos de investigación, semilleros de investigación, líneas de investigación y proyectos de semilleros de investigación.</p>
                    </a>
                </div>
