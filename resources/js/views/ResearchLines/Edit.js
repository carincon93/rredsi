...
import { find, update, rules } from '~/containers/ResearchLines';
...
class Edit extends Component {
    ...
    render() {
        const { rules, requestValidation, researchLine } = this.state;
        if (researchLine.id == null) {
                    ...
                    >
                        <div className="form-group">
                            ...
                            <input
                                ...
                                id="name"
                                defaultValue={researchLine.name}
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                id="objectives"
                                defaultValue={researchLine.objectives}
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                id="mission"
                                defaultValue={researchLine.mission}
                                rows="3"
                                onFocus={this.handleFocus}
                                onChange={this.handleChange}
                            >
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                id="vision"
                                defaultValue={researchLine.vision}
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                id="achievements"
                                defaultValue={researchLine.achievements}
