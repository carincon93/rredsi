...
import { store, rules } from '~/containers/ResearchTeamAdmin';
...
class Create extends Component {
    ...
    setValidation(rules, value) {
        ...
        const rulesResearchTeamAdmin    = validate(rules, value,requestValidation, touched);
    
        this.setState({rules: rulesResearchTeamAdmin });
    }
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="custom-control custom-radio">
                                <input type="radio" id="is_enabled_yes" name="is_enabled" className="custom-control-input" onFocus={this.handleFocus} onChange={this.handleChange} defaultChecked={this.state.formData.is_enabled === 1} value="1" />
                                <label className="custom-control-label" htmlFor="is_enabled_yes">Si</label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="radio" id="is_enabled_no" name="is_enabled" className="custom-control-input" onFocus={this.handleFocus} onChange={this.handleChange} defaultChecked={this.state.formData.is_enabled === 0} value="0" />
